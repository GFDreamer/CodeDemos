...
// Navigation Color
#define DefaultNavbarTintColor UIColorFromRGB(0xFFFFFF)
#define DefaultNavTintColor UIColorFromRGB(0xE63939)
#define DefaultNavTitleColor UIColorFromRGB(0x000000)
